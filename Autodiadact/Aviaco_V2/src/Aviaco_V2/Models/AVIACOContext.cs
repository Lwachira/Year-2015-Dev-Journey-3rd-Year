...
namespace Aviaco_V2.Models
{
    public partial class AVIACOContext : DbContext
    {
        ...
        {
            options.UseSqlServer(@"Data Source=DESKTOP-s2DDF7Q;Database=AVIACO;Trusted_Connection=True;");
        }
        ...
        // Unable to generate entity type for table 'dbo.CREW'. Please see the warning messages.
    }
}